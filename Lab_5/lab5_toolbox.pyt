...
class tool:
    def __init__(self):
        ...
        self.description = "This determines which buildings on TAMU's campus are near a targeted building"
    ...
    def execute(self, parameters, messages):
        ...
        arcpy.TableToTable_conversion(gdb_path + '\Garage_Buildings_Intersection.dbf', r'C:\Mac\Home\Documents\GEOG676\repo\venkatramani-online-GEOG676-spring2025\Lab_5', 'nearbyBuildings.csv')
